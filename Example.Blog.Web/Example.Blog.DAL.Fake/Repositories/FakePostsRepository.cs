using Example.Blog.DAL.Fake.Models;
using Example.Blog.Domain.Interfaces.Models;
using Example.Blog.Domain.Interfaces.Repositories;
using Example.Blog.Domain.Models;
...
namespace Example.Blog.DAL.Fake.Repositories
{
    /// <summary>
    /// Repository of posts
    /// </summary>
